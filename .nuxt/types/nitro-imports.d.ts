declare global {
  ...
  const formatDate: typeof import('../../server/utils/datefomatter')['formatDate']
  const formatDateToMonthDay: typeof import('../../server/utils/formatDatetoMonth')['formatDateToMonthDay']
  ...
  const getUserFormEvent: typeof import('../../server/utils/auth')['getUserFormEvent']
...
export { getUserFormEvent } from '../../server/utils/auth';
export { formatDate } from '../../server/utils/datefomatter';
export { formatDateToMonthDay } from '../../server/utils/formatDatetoMonth';
export { verifyPassword } from '../../server/utils/password';